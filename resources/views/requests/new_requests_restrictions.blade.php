...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الطلبات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافة طلب قيد جديد</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class="border" style="border: 1px solid #0064e7 !important;">
							<div class="bg-gray-100 nav-bg">
								...
								padding: 9px 5px 9px 5px;">
									<a class="nav-link ml-1" data-toggle="tab" href="#tabCont1">قيد ميلاد</a>
									<a class="nav-link ml-1" data-toggle="tab" href="#tabCont2">قيد زواج</a>
									<a class="nav-link ml-1" data-toggle="tab" href="#tabCont3">قيد طلاق</a>
									<a class="nav-link ml-1" data-toggle="tab" href="#tabCont4">تصحيح اوتثبيت اوابطال قيد</a>
									<a class="nav-link ml-1" data-toggle="tab" href="#tabCont5">بيان وفاة</a>
								</nav>
							</div>
								...
								<div class="tab-pane active show" id="tabCont1">
									<div class="center1">
										<div class="form-header">
											<h6 class="mb-4">طلب الحصول على قيد ميلاد</h6>
										</div>
									</div>
											...
											<div class="tooltip-demo">
												...
												<div class="form-row" style="flex-wrap: nowrap; align-items: center;" dir="rtl">
													...
													<div class="form-holder">
														...
														<div class="col-sm-3">
															<input type="text" placeholder="الشارع" class="form-control" value="{{ old('street_accom') }}" name="street_accom" id="street_accom" required />
														</div>
														<div class="col-sm-3">
															<input type="text" placeholder="المنزل" class="form-control" value="{{ old('house_accom') }}" name="house_accom" id="house_accom" required/>
														</div>
														<div class="col-sm-3">
