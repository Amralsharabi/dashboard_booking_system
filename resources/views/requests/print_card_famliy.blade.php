				...
				<div class="row">
					...
					<div id="mydivs" class="container bg-white mydiv " style=" margin-bottom:50px; padding:10px 8px 10px 8px; ">
						...
						<tr>
							...
							<tr class="text-center tr">
								<th colspan="6">محل الاقامة الحالي</th>
							</tr>
							<tr>
							...
							<tr class="text-center tr">
								<th colspan="6">محل الاقامة السابق</th>
							</tr>
							<tr>
								<td class="th">دولة الاقامة</td>
								<td>{{$FamilyCard->countrieaccomform->countrie_na}}</td>
								<td class="th">محافظة الاقامة</td>
								<td>{{$FamilyCard->provinceacomform->na_prov}}</td>
								<td class="th">مديرية الاقامة</td>
								<td>{{$FamilyCard->directorateacomform->na_dire}}</td>
							</tr>
							<tr>
								<td class="th">عزلة/قرية</td>
								<td>{{$common_data->village_accom}}</td>
							...
							<tr class="text-center tr">
								<th colspan="6">بيانات البطاقة الشخصية</th>
							</tr>
							<tr>
								<td class="th">رقم البطاقة</td>
								<td>{{$common_data->id_card}}</td>
								<td class="th">تاريخ الاصدار</td>
								<td>{{$FamilyCard->date_version}}</td>
								<td class="th">مركز الاصدار</td>
								<td>{{$FamilyCard->CardVersionCenter->na_center}}</td>
							</tr>
							{{-- </tbody> --}}
						</table>
						<table class="table table-sm table-bordered bg-white" dir="rtl">
							<tr style="background-color: #51676e81">
								<td colspan="4"><b>الاقرار:</b> اقر بأن جميع البيانات الواردة اعلاه صحيحة وانه لم يسبق لي الحصول على بطاقة عائلية من قبل وعلى مسئوليتي</td>
							</tr>
							<tr>
								<th class="th">تاريخ الطلب</th>
								<td style="width: 40%">{{$FamilyCard->created_at}}</td>
